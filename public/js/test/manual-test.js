...
playStableButton.addEventListener('click', () =>
...
playRainButton.addEventListener('click', () =>
  ambientCoffee.playBrew('rain-sounds')
)
...
playCombinedButton.addEventListener('click', () =>
  ambientCoffee.playBrew('combined-sounds')
)
